"""
Local test for the edge detection Lambda — runs the handler without AWS.

Usage:
    python test_edge.py
    python test_edge.py --size large
"""
...
LAMBDA_DIR = HERE.parent / "lambdas" / "edge"
...
def main():
    ...
    print("Invoking edge detection Lambda handler...")
    ...
    out_path = outputs_dir / "output_edge.jpg"
